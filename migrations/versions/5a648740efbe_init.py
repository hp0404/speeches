...
def upgrade():
    ...
    op.create_index(
        op.f("ix_documents_metadata_id"), "documents_metadata", ["id"], unique=False
    )
    op.create_table(
        "sentences",
        sa.Column("id", sa.Integer(), nullable=True),
        ...
        sa.Column(
            "text_lemmatized", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["document_id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "match_processed", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
